...
const only = names.forEach(name => {});


const mix = names.forEach((name, index) => {});
...
console.log(only,mix,uppercaseProvinces, nameLengths, sortedProvinces, remainingProvinceCount, provinceObject);
